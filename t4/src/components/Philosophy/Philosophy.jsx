...
function Philosophy() {
  ...
  const steps = [
    {
      key: 1,
      teacup: "/img/philo-imgs/teacup/fill1.png",
      image: "/img/philo-imgs/steps-imgs/step1.png",
    ...
    {
      key: 2,
      teacup: "/img/philo-imgs/teacup/fill2.png",
      image: "/img/philo-imgs/steps-imgs/step2.png",
      alt: "change",
    ...
    {
      key: 3,
      teacup: "/img/philo-imgs/teacup/fill3.png",
      image: "/img/philo-imgs/steps-imgs/step3.png",
      alt: "change",
    ...
    {
      key: 4,
      teacup: "/img/philo-imgs/teacup/fill4.png",
      image: "/img/philo-imgs/steps-imgs/step4.png",
      alt: "change",
    ...
    {
      key: 5,
      teacup: "/img/philo-imgs/teacup/fill5.png",
      image: "/img/philo-imgs/steps-imgs/step5.png",
      alt: "change",
    ...
    {
      key: 6,
      teacup: "/img/philo-imgs/teacup/fill6.png",
      image: "/img/philo-imgs/steps-imgs/step6.png",
      alt: "change",
  ...
  return (
    <div className="philosophy-section">
      <h1>Our Tea</h1>
      <img className="spilled-tea" alt="An organic shape with a brown gradient" src="/img/philo-imgs/spilled-tea.png"/>
      <p
      ...
      <div className="leaf-images">
        <img className="leaf1" alt="A drawing of a light green tea leaf" src="/img/philo-imgs/leaves/leaf1.png"/>
        <img className="leaf2" alt="A drawing of a dark green tea leaf" src="/img/philo-imgs/leaves/leaf2.png"/>
      </div>
      <div className="steps">
